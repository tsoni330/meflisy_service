...
class localProfession2 extends StatefulWidget {
  String title, state, city, locality, sub_profession;

  localProfession2(this.title, this.state, this.city, this.locality,
      this.sub_profession);
  

  @override
  _localProfession2State createState() => _localProfession2State();


}

class _localProfession2State extends State<localProfession2> {
  ...
  Future local_Partners() async {
    String url = 'http://meflisyservice.com/local_partner2.php';
